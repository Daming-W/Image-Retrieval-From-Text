...
def download_voc2007(root):
    ...
    if not os.path.exists(path_devkit):
        ...
        if not os.path.exists(cached_file):
            ...
            download_url(voc07urls['devkit'], cached_file)
    ...
    if not os.path.exists(path_images):
        ...
        if not os.path.exists(cached_file):
            ...
            download_url(voc07urls['trainval_2007'], cached_file)
    ...
    if not os.path.exists(test_anno):
        ...
        if not os.path.exists(cached_file):
            ...
            download_url(voc07urls['test_images_2007'], cached_file)
    ...
    if not os.path.exists(test_image):
        ...
        if not os.path.exists(cached_file):
            ...
            download_url(voc07urls['test_anno_2007'], cached_file)
...
def download_voc2012(root):
    ...
    if not os.path.exists(path_devkit):
        ...
        if not os.path.exists(cached_file):
            ...
            download_url(voc12urls['devkit'], cached_file)
    ...
    if not os.path.exists(path_images):
        ...
        if not os.path.exists(cached_file):
            ...
            download_url(voc12urls['trainval_2012'], cached_file)
